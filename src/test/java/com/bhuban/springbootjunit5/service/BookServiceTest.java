...
public class BookServiceTest {
    ...
    void givenBookId_whenGetBook_ThenBookRetrieved() {
        ...
        //when
        BookDto bookDto1 = bookService.getBook(existingBookId);
    ...
    void givenBookId_whenGetNonExistingBook_ThenExceptionThrown() {
        ...
        //when
        EntityNotFoundException throwException = assertThrows(EntityNotFoundException.class, () ->  bookService.getBook(nonExistingBookId));
